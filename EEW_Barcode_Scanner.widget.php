 ...
 * ------------------------------------------------------------------------
 *
 * EEW_EE_Barcode_Scanner
 * Displays a List of EE_Barcode_Scanner in the Sidebar
 *
 * @package			Event Espresso
 ...
 * ------------------------------------------------------------------------
 */
class EEW_EE_Barcode_Scanner extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'ee-ee_barcode_scanner-widget',
			__( 'Event Espresso EE_Barcode_Scanner Widget', 'event_espresso' ),
			 array(
			 	'description' => __( 'Displays Espresso EE_Barcode_Scanner in a widget.', 'event_espresso' )
			 ),
			array(
				'width' => 300,
				'height' => 350,
				'id_base' => 'ee-ee_barcode_scanner-widget'
			)
		);
	}
...
<?php
	...
	public function widget( $args, $instance ) {
		...
		if ( isset( $post->post_content )) {
			 ...
			 if ( strpos( $post->post_content, '[ESPRESSO_EE_BARCODE_SCANNER') === FALSE ) {
				 EED_EE_Barcode_Scanner::$shortcode_active = TRUE;
...
// End of file EEW_EE_Barcode_Scanner.widget.php
// Location: /wp-content/plugins/espresso-ee-barcode-scanner/EEW_EE_Barcode_Scanner.widget.php

...
class EED_Barcode_Scanner extends EED_Module {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 'eea-bs-chosen', EE_BARCODE_SCANNER_URL . 'core/third_party_libraries/chosen/chosen.' . $script_men . 'js', array( 'eea-bs-chosen-jquery' ), EE_BARCODE_SCANNER_VERSION, true );

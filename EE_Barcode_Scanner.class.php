	...
	public static function register_addon() {
		...
		EE_Register_Addon::register(
			...
			array(
				...
				'config_class' 			=> 'EE_Barcode_Scanner_Config',
				'config_name' 		=> 'EE_Barcode_Scanner',
				'autoloader_paths' => array(
					'EE_Barcode_Scanner' 						=> EE_BARCODE_SCANNER_PATH . 'EE_Barcode_Scanner.class.php',
					'EE_Barcode_Scanner_Config' 			=> EE_BARCODE_SCANNER_PATH . 'EE_Barcode_Scanner_Config.php',
...
//				'dms_paths' 			=> array( EE_BARCODE_SCANNER_PATH . 'core' . DS . 'data_migration_scripts' . DS ),
				...
				'widget_paths' 		=> array( EE_BARCODE_SCANNER_PATH . 'EEW_EE_Barcode_Scanner.widget.php' ),
				...
				'class_paths' => EE_BARCODE_SCANNER_PATH . 'core' . DS . 'db_classes',
				'model_paths' => EE_BARCODE_SCANNER_PATH . 'core' . DS . 'db_models',
				'class_extension_paths' => EE_BARCODE_SCANNER_PATH . 'core' . DS . 'db_class_extensions',
				'model_extension_paths' => EE_BARCODE_SCANNER_PATH . 'core' . DS . 'db_model_extensions'
			)
		);
	}
	...
	public function plugin_actions( $links, $file ) {
		if ( $file == EE_BARCODE_SCANNER_BASENAME ) {
			// before other links

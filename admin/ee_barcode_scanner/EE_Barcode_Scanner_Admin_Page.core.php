 ...
 * ------------------------------------------------------------------------
 *
 * EE_Barcode_Scanner_Admin_Page
 *
 * This contains the logic for setting up the EE_Barcode_Scanner Addon Admin related pages.  Any methods without PHP doc comments have inline docs with parent class.
 *
 *
 * @package			EE_Barcode_Scanner_Admin_Page (ee_barcode_scanner addon)
 * @subpackage 	admin/EE_Barcode_Scanner_Admin_Page.core.php
...
class EE_Barcode_Scanner_Admin_Page extends EE_Admin_Page {
	...
	protected function _define_page_props() {
		$this->_admin_page_title = EE_BARCODE_SCANNER_LABEL;
		$this->_labels = array(
	...
	protected function _set_page_config() {
		...
		$this->_page_config = array(
			...
			'usage' => array(
				'nav' => array(
					'label' => __('EE_Barcode_Scanner Usage', 'event_espresso'),
					'order' => 30
					),
				'require_nonce' => FALSE
			)
	...
	public function load_scripts_styles() {
		...
		wp_localize_script( 'espresso_ee_barcode_scanner_admin', 'eei18n', EE_Registry::$i18n_js_strings );
	}
	...
	protected function _basic_settings() {
		$this->_settings_page( 'ee_barcode_scanner_basic_settings.template.php' );
	}
	...
	protected function _update_settings(){
		...
		EE_Config::instance()->update_config( 'addons', 'EED_EE_Barcode_Scanner', $config );
...
//	}
	private function _sanitize_config_input( $top_level_key, $second_level_key, $value ){
		$sanitization_methods = array(
			'display'=>array(
				'enable_ee_barcode_scanner'=>'bool',
//				'ee_barcode_scanner_height'=>'int',
//				'enable_ee_barcode_scanner_filters'=>'bool',
...
// End of file EE_Barcode_Scanner_Admin_Page.core.php
// Location: /wp-content/plugins/espresso-ee-barcode-scanner/admin/ee_barcode_scanner/EE_Barcode_Scanner_Admin_Page.core.php
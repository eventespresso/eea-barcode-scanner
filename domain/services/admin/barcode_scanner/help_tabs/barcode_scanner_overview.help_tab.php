 ...
 */
?>
<p><strong><?php esc_html_e('Scanning Barcodes', 'event_espresso'); ?></strong></p>
<p>
    <strong><?php esc_html_e('Step 1:', 'event_espresso'); ?></strong>
    <?php esc_html_e('Click on the dropdown and locate your event and click on it.', 'event_espresso'); ?>
</p>
<p>
    <strong><?php esc_html_e('Step 2:', 'event_espresso'); ?></strong>
    <?php
    /* phpcs:disable Generic.Files.LineLength.TooLong */
    esc_html_e(
        'Decide if you want to continuously scan attendees/registrants or lookup an attendee and manually check them in.',
        'event_espresso'
    );
    /* phpcs:enable */
    ?>
...
<p>
    <strong><?php esc_html_e('Step 3:', 'event_espresso'); ?></strong>
    <?php
    /** phpcs:disable Generic.Files.LineLength.TooLong */
    esc_html_e(
...
<p>
    <strong><?php esc_html_e('Step 4:', 'event_espresso'); ?></strong>
    <?php
    /** phpcs:disable Generic.Files.LineLength.TooLong */
    esc_html_e(
...
<p>
    ...
    /** phpcs:disable Generic.Files.LineLength.TooLong */
    printf(
        /* Translators: Link to viewing offsite features about the scanner */
        esc_html__(
